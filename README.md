![Likeness home page screenshot](src/assets/images/home-screenshot.png)

# _Likeness: Photo Gallery_

#### _A React photo gallery application built_
...
A community photo gallery built with React and Firebase. Users can currently view and add photos.

## Preview

Live preview: [Likeness](https://likeness-gallery.web.app/)
...
* Clone the repository with the following git terminal command: ```$ git clone https://github.com/chloeloveall/likeness.git```
* Open the project's root directory (```likeness```) in your terminal

#### Download

* Open the repository on GitHub: [chloeloveall/likeness](https://github.com/chloeloveall/likeness)
...
* Select ```likeness``` and click ```open``` to view the project

### Launching the program

* Navigate to the root directory (```likeness/```) and install required dependencies by running the following terminal command: ```npm install```
...
![Color palette](src/img/likeness-palette.png)
...
* Report issues [here](https://github.com/chloeloveall/likeness/issues) and select the ```New issue``` button
for support

## Feature Development Roadmap

* Implement full CRUD
* Build more auth required features 
* Complete UI 
* Add nodemailer contact form
## Contributing
...
![github followers](https://img.shields.io/github/followers/chloeloveall?style=social) &nbsp; ![github forks](https://img.shields.io/github/forks/chloeloveall/likeness?label=Forks&style=social) &nbsp; ![github stars](https://img.shields.io/github/stars/chloeloveall/likeness?style=social)
